      ...
      <PageWrapper breadCrumbsRoutes={breadCrubmsRoutes} pageTitle="IT право">
        <div className="offer__description">
          ...
          <p className="offer__paragraph bg-white">
            ...
            национальным законодательством. В том числе это касается ИТ специалистов, которые работают как фрилансеры на
            различных платформах (к примеру Fiverr, Upwork и тд). Несоблюдение требований по регистрации такой
          ...
          <p className="offer__paragraph bg-white mt25">
            Кроме этого, большим спросом среди ИТ специалистов пользуется релокация бизнеса за границу. Много зарубежных
            юрисдикций предлагают благоприятные налоговые системы для иностранных инвесторов. Поэтому ЮК Лавиант
            предлагает:
          </p>
          <ul className="bg-white">
            <li className="offer__paragraph">
