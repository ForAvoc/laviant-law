        ...
        <div>
          ...
          <div className="offer__description">
            ...
            <p className="offer__paragraph bg-white mt25">
              Получение лицензии достаточно длительный и трудоемкий процесс, который может длиться от нескольких недель
              до нескольких месяцев, в зависимости от их вида. Чтобы получить возможность заняться бизнесом как можно
              быстрее Вы можете приобрести готовую компанию с интересующей вас лицензией. В наличии всегда есть
