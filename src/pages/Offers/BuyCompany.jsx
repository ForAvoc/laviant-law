    ...
    <div className="offer">
      <PageWrapper breadCrumbsRoutes={breadCrubmsRoutes} pageTitle="Купить компанию">
        <div className="offer__description">
          ...
          <p className="offer__paragraph bg-white">
            ЮК ЛАВИАНТ предлагает готовые компании разных годов регистрации по Вашим запросам. Покупка готовой компании
            экономит Ваше время, и всего через два дня у вас будет готовое к работе предприятие.
          </p>
