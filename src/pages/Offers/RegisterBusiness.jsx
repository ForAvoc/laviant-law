        ...
        <div className="offer__description">
          ...
          <ul className="bg-white">
            <li className="offer__paragraph">
              Регистрация ФЛП (для любых видов деятельности, предусмотренных законодательством, в том числе регистрацию
              физического-лица предпринимателя для IT-специалистов).
            </li>
            <li className="offer__paragraph">
              Регистрация ФЛП по доверенности, выбор местоположения деятельности без привязки к прописке.
            </li>
            <li className="offer__paragraph">
              Регистрация ООО, подбор КВЕДов, первичное налоговое консультирование, регистрация общества с ограниченной
              ответственностью на общей системе налогообложения, с НДС и на едином налоге.
            </li>
            <li className="offer__paragraph">
              Регистрация фермерского хозяйства, консультирование по созданию ФХ, подбору КВЕДов, подготовка к переходу
              на 4 группу единого налога, бухгалтерское и юридическое сопровождение деятельности фермерского хозяйства.
            </li>
          ...
          <ol className="offer__list bg-white">
            ...
            <li>
              скан-копия документов, подтверждающих регистрацию иностранного лица в стране его местонахождения (выписка
              из торгового, банковского, судебного реестра) (если учредители юридические лица нерезиденты);
            </li>
