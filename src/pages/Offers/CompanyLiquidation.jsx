    ...
    <div className="offer">
      <PageWrapper breadCrumbsRoutes={breadCrubmsRoutes} pageTitle="Ликвидация бизнеса">
        <div className="offer__description">
          ...
          <p className="offer__paragraph bg-white">В данном случае мы предлагаем два варианта нашего сотрудничества:</p>
          <ul className="bg-white mt25">
            <li className="offer__paragraph">
              Официальная ликвидация через налоговую, с подготовкой полного пакета документов, необходимых для закрытия
              компании.
            </li>
            <li className="offer__paragraph">
