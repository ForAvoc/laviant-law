      ...
      <PageWrapper breadCrumbsRoutes={breadCrubmsRoutes} pageTitle="Регистрация торговых марок">
        <div className="offer__description">
          ...
          <ul className="bg-white mt25">
            ...
            <li className="offer__paragraph">
              При ориентации вашего бизнеса на международный рынок, регистрация торговой марки в Украине является первым
              этапом на пути к регистрации международной торговой марки.
            </li>
            <li className="offer__paragraph">
