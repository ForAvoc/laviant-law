      ...
      <PageWrapper breadCrumbsRoutes={breadCrubmsRoutes} pageTitle="Внесения изменений в ЕДР">
        <div className="offer__description">
          ...
          <p className="offer__paragraph bg-white">
            ...
            большинство компаний периодически меняет вид деятельности, адрес, уставной фонд и так далее. Например, может
            понадобиться вторичная регистрация устава ООО (ТОВ), замена руководителя или изменения юридического адреса –
            все эти действия называют вторичной регистрацией.
          </p>
          <p className="offer__paragraph bg-white">
